...
void updateColor()
{
  if(is_on)
  {
      ...
      for(int i = 0; i < NUMPIXELS; i++)
      {
        // Inverse l'ordre des canaux de couleurs pour correspondre aux LEDs WS2815 (BGR)
        //pixels.setPixelColor(i, pixels.Color(rgb_colors[0], rgb_colors[1], rgb_colors[2]));
        //pixels.setPixelColor(i, pixels.Color(rgb_colors[0], rgb_colors[2], rgb_colors[1]));

        //pixels.setPixelColor(i, pixels.Color(rgb_colors[2], rgb_colors[1], rgb_colors[0]));
        //pixels.setPixelColor(i, pixels.Color(rgb_colors[2], rgb_colors[0], rgb_colors[1]));

        //pixels.setPixelColor(i, pixels.Color(rgb_colors[1], rgb_colors[2], rgb_colors[0]));
        pixels.setPixelColor(i, pixels.Color(rgb_colors[1], rgb_colors[0], rgb_colors[2]));
